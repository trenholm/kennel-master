  ...
  <div class="row-fluid">
    <div class="span6" id="info-section" name="info-section">
      ...
      <table class="table table-striped" id="account-section" name="account-section">
        <tbody>
          <tr id="usernameField" name="usernameField">
            <th>Username:</th>
            <td id="username" name="username"></td>
          </tr>
          <tr id="emailField" name="emailField">
            <th>Email:</th>
            <td id="email" name="email"></td>
          </tr>
          <tr id="creditcardField" name="creditcardField">
            <th>Credit Card:</th>
            <td id="creditcard" name="creditcard"></td>
          </tr>
          <tr id="passwordField" name="passwordField" style="display:none;">
            <th>New Password:</th>
            <td id="password" name="password"></td>
          </tr>
          <tr id="confirmpasswordField" name="confirmpasswordField" style="display:none;">
            <th>Confirm New Password:</th>
            <td id="confirmpassword" name="confirmpassword"></td>
          </tr>
        </tbody>
      </table>
